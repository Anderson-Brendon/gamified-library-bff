    ...
    return (
        <main className={"flex flex-col"}>
            ...
            <div className={"flex grow flex-col items-center justify-evenly sm:justify-around sm:flex-row sm:items-baseline"}>
                ...
                <a href={`/my-profile/completed`} className={"mb-4 border-2 border-black bg-white px-5 py-3 font-semibold text-black shadow-[4px_4px_0_0] hover:translate-1 hover:shadow-none focus:ring-2 focus:ring-yellow-300 focus:outline-0"}>
                    Completed
                </a>
            </div>
        </main>)
